namespace MaskTransitions
{
    ...
    public class TransitionManager : MonoBehaviour
    {
        ...
        Tween StartAnimationForLoad(float? totalTime = null)
        {
            ...
            if (rotation)
            {
                Tween blueTweenRotate = maskRect.DORotate(new Vector3(0, 0, 90), animationTime).SetEase(Ease.InOutQuad);
        ...
        void EndAnimation(float? totalTime = null)
        {
            ...
            if (rotation)
                parentMaskRect.DORotate(new Vector3(0, 0, 90), animationTime).SetEase(Ease.InOutQuad);
        }
        #endregion
